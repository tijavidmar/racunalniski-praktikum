...
\begin{table}[h]
   ...
   \begin{tabular}{|c|c|c|}
      \hline
      \large 8 & \large 1 & \large 6 \\ \hline
      \large 3 & \large 5 & \large 7 \\ \hline
      \large 4 & \large 9 & \large 2 \\ \hline  
   \end{tabular}
\end{table}
...
(glej sliko~\ref{fig:safrada} za fotografijo) vsebuje magični kvadrat reda 4.
% sklic: fig:sagrada
...
\begin{proof}
   ...
   števil (glej~\ref{eg:numbers} na strani \pageref{eq:numbers}) enaka
...
\[
\mathcal{M}_{2}(n, \mathrm{A}, \mathrm{D})
  = \frac{1}{2} n ( 2\mathrm{A} + \mathrm{D}(n^{2} - 1))
\]
